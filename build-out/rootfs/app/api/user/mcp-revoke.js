...
async function invalidateProMcpTokenCache(tokenId) {
  if (!tokenId) return;
  await writeNegCache(tokenId);
}

// api/user/mcp-revoke.ts
var config = { runtime: "edge" };
var CONVEX_TIMEOUT_MS = 3e3;
async function callConvexRevoke(userId, tokenId) {
...
async function revokeHandler(req, deps) {
