...
var INTERNAL_EVENT_TYPES = /* @__PURE__ */ new Set(["flush_quiet_held", "channel_welcome", "watchlist_story_alert"]);
function isInternalNotifyEventType(eventType) {
...
async function handler(req) {
  ...
  const variant = typeof body.variant === "string" ? body.variant : void 0;
