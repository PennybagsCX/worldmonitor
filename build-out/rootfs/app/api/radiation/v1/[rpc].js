...
function createRadiationServiceRoutes(handler, options) {
  return [
    {
      method: "GET",
...
init_redis();
var REDIS_CACHE_KEY = "radiation:observations:v1";
var DEFAULT_MAX_ITEMS = 18;
var MAX_ITEMS_LIMIT = 25;
...
var listRadiationObservations = async (_ctx, req) => {
