...
// server/worldmonitor/wildfire/v1/list-fire-detections.ts
var COMPACT_SEED_CACHE_KEY = "wildfire:fires-bootstrap:v1";
var COMPACT_SEED_META_KEY = "seed-meta:wildfire:fires-bootstrap";
var CANONICAL_SEED_CACHE_KEY = "wildfire:fires:v1";
var CANONICAL_SEED_META_KEY = "seed-meta:wildfire:fires";
var listFireDetections = async (_ctx, _req) => {
  try {
    let [result, meta] = await Promise.all([
      getCachedJson(COMPACT_SEED_CACHE_KEY, true),
      getCachedJson(COMPACT_SEED_META_KEY, true)
    ]);
    if (!result) {
      [result, meta] = await Promise.all([
        getCachedJson(CANONICAL_SEED_CACHE_KEY, true),
        getCachedJson(CANONICAL_SEED_META_KEY, true)
      ]);
    }
    if (!result) return { fireDetections: [], pagination: void 0, fetchedAt: 0, dataAvailable: false };
    ...
    return { fireDetections: [], pagination: void 0, fetchedAt: 0, dataAvailable: false };
  }
};
