...
function createThermalServiceRoutes(handler, options) {
  return [
    {
      method: "GET",
...
init_redis();
var REDIS_CACHE_KEY = "thermal:escalation:v1";
var DEFAULT_MAX_ITEMS = 12;
var MAX_ITEMS_LIMIT = 25;
async function readSeededThermalWatch() {
  try {
    return await getCachedJson(REDIS_CACHE_KEY, true);
  } catch {
    return null;
  }
}
...
var listThermalEscalations = async (_ctx, req) => {
