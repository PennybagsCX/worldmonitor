...
var ACTIVE_SUBSCRIPTION_EXISTS = "ACTIVE_SUBSCRIPTION_EXISTS";
var CHECKOUT_RELAY_USER_AGENT = "worldmonitor-checkout-edge/1.0";
function createDefaultCreateCheckoutDeps() {
  return {
    validateBearerToken,
    fetch: (...args) => globalThis.fetch(...args)
  };
}
var createCheckoutDeps = createDefaultCreateCheckoutDeps();
function __setCreateCheckoutDepsForTests(overrides) {
  createCheckoutDeps = overrides ? { ...createDefaultCreateCheckoutDeps(), ...overrides } : createDefaultCreateCheckoutDeps();
}
...
function checkoutBlockedBody(data) {
  return {
...
async function handler(req, ctx) {
  ...
  try {
          ...
          json(
            {
              ...
              message: typeof data?.message === "string" ? data.message : "Checkout is temporarily rate limited. Retry shortly."
            },
            429,
            cors,
    ...
    console.error("[create-checkout] Relay failed:", err.message);
